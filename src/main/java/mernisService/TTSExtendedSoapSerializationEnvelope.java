...
public class TTSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TTSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TTSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TTSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TTSDateTimeConverter dateTimeConverter = new TTSStandardDateTimeConverter();

    public TTSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TTSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TTSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TTSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TTSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TTSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
