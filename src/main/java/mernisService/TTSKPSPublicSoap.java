...
public class TTSKPSPublicSoap
{
    ...
    public TTSKPSPublicSoap(){}

    public TTSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TTSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TTSExtendedSoapSerializationEnvelope envelope= new TTSExtendedSoapSerializationEnvelope(TTSExtendedSoapSerializationEnvelope.VER11);
